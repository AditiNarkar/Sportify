            ...
            <div class="admin-noti">
                ...
                <div   onclick="window.location.href='admin_notifications_contact_us.jsp'" >Contacted Us</div> 
                 <div class="divider-tabs"></div>
                  ...
                  <div class="divider-tabs"></div>
                  <div class="active" onclick="window.location.href='admin_member_noti.jsp'" >Member</div> 
                ...
                <div class="noti-content">
                    <table class="table table-sm table-dark">
                        ...
                        ResultSet rs = st.executeQuery("SELECT * FROM notifications_members ORDER BY Notification_No DESC");
                        while(rs.next())
                        {
                        %>
                          <tr>
