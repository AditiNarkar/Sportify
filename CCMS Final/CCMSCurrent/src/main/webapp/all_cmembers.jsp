       ...
       <div class="sidebar">
        ...
        <div class="members-page-list">
            ...
            <%
            	Statement st6 = con.createStatement();
    	  		ResultSet rs6 = st6.executeQuery("SELECT COUNT(*) FROM member WHERE Status = 'T' AND Club_Id =  '"+ session_Club_Id +"'");
    	  		while(rs6.next())
    	  		{
            
            %>
            <h5>Currently in Team: <%= rs6.getString(1) %><% } %></h5>
            <div class="divider2"></div>
        ...
        <div class="members-table">
            ...
            <thead>
                ...
                <th scope="col">Delete From Team</th>
