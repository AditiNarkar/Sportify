  	      		...
  	      		if(rs.next() && rs3.next())
  	      		{
  	        		...
  	        		while(rs111.next())
  	        		{
  	        			...
  	        			String sss = "INSERT INTO team (Member_Id, Club_Id, Challenge_Id, Status) Values (?,?,?,?)";
	  	  				...
	  	  				psts.setString(1,rs111.getString(1));
	  	  				psts.setString(2,session_Club_Id);
	  	  				psts.setString(3,accept_challengeid);
	  	  				psts.setString(4,"Pending");
	  	  				psts.executeUpdate();
  	        		...
  	        		ResultSet rs1111 = st1111.executeQuery("SELECT Member_Id FROM member WHERE Status = 'T' AND (Club_Id = '" + rs.getString(2) +"' OR Club_Id = '" + rs3.getString(2) +"')" );
  	        		while(rs1111.next())
  	        		{
  	        			
  	        			String sss = "INSERT INTO team (Member_Id, Club_Id, Challenge_Id, Status) Values (?,?,?,?)";
	  	  				PreparedStatement psts = con.prepareStatement(sss);
	  	  				psts.setString(1,rs1111.getString(1));
	  	  				psts.setString(2,session_Club_Id);
	  	  				psts.setString(3,accept_challengeid);
	  	  				psts.setString(4,"Pending");
	  	  				psts.executeUpdate();
