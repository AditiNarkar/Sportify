    ...
    <div class="wrapper">
       <div class="sidebar">
            ...
            <ul>
				...
				<li class="active"><a href="admin_notifications.jsp"><i class="bi bi-bell-fill"></i>Notifications</a></li>
            ...
            <div class="admin-noti">
               ...
               <div class="tabs">
                ...
                <div   onclick="window.location.href='admin_notifications_contact_us.jsp'" >Contacted Us</div> 
                 <div class="divider-tabs"></div>
                  <div onclick="window.location.href='admin_coach_noti.jsp'" >Coach </div> 
                  <div class="divider-tabs"></div>
                  <div class="active"   onclick="window.location.href='admin_team_noti.jsp'" >Team</div> 
                  <div class="divider-tabs"></div>
                ...
                <div class="noti-content">
                    <table class="table table-sm table-dark">
                        ...
                        ResultSet rs = st.executeQuery("SELECT * FROM notifications_team ORDER BY Notification_No DESC");
                        while(rs.next())
                        {
                        %>
                          <tr>
