    ...
    <div class="wrapper">
       <div class="sidebar">
            ...
            <div class="admin-noti">
                ...
                <div class="tabs">
                <div class="active" onclick="window.location.href='admin_notifications.jsp'" >Add Club Requests</div>
                ...
                <div class="noti-content">
                    <table class="table table-sm table-dark">
                        ...
                        ResultSet rs = st.executeQuery("SELECT * FROM notifications_admin WHERE Noti_Category = 'add club req' ORDER BY Notification_No DESC");
                        int i = 1;
                        while(rs.next())
                        {
                        %>
                          <tr>
                            ...
                            ResultSet rsm = stm.executeQuery(" SELECT Status FROM clubs WHERE Club_Id = '" + rs.getString(5) + "'");
                            if(rsm.next())
                            {
                            %>
                            <td><%= rsm.getString(1) %></td>
